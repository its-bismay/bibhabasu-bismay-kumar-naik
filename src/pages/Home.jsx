...
import { ArrowRight, Download, Terminal, Code2, Zap, FileJson, Palette, Server, Database, Cpu, Cloud, Newspaper } from 'lucide-react';
...
const skillIcons = {
  Code2, Zap, FileJson, Palette, Server, Database, Cpu, Cloud
};
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            >
              ...
              <h1 className="text-massive uppercase leading-[0.8] mb-8">
                Crafting<br />
                <span className="text-zinc-800">Digital</span><br />
                Future
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                <Button size="lg" className="rounded-xl px-8 font-bold h-14" asChild>
                  <Link to="/projects">
                    View Projects <ArrowRight className="ml-2 w-4 h-4" />
                  </Link>
                </Button>
                <Button size="lg" variant="outline" className="rounded-xl px-8 font-bold h-14 bg-zinc-950/50 backdrop-blur-sm">
                  My Journey
                </Button>
              </div>
            </motion.div>
          ...
          <div className="lg:col-span-4 hidden lg:flex flex-col gap-6">
            ...
            >
              <div className="flex justify-between items-start">
                <div>
                  <h3 className="text-sm font-bold uppercase tracking-wider text-primary mb-1">DSA Ranking</h3>
                  <p className="text-xs text-muted-foreground uppercase font-mono">Live Performance</p>
                </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="text-center">
                  ...
                  <div className="text-[10px] uppercase text-muted-foreground font-bold">Solved</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold font-mono text-orange-400">124</div>
                  <div className="text-[10px] uppercase text-muted-foreground font-bold">Streak</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold font-mono text-primary">1985</div>
                  <div className="text-[10px] uppercase text-muted-foreground font-bold">Rating</div>
                </div>
              </div>

              <div className="h-24 w-full flex items-end gap-1.5 px-2">
                {[20, 45, 30, 60, 85, 75, 100].map((h, i) => (
                  <div 
                    key={i} 
                    style={{ height: `${h}%` }}
            ...
            >
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Latest Update</h3>
                <ArrowRight className="w-4 h-4 text-zinc-600 group-hover:text-primary transition-colors" />
              </div>
              <h4 className="text-xl font-bold mb-2">Nexus Cloud Storage</h4>
              <p className="text-sm text-muted-foreground line-clamp-2 mb-4">
                Building a decentralized encrypted storage solution.
              </p>
              <div className="flex gap-2">
                <span className="text-[10px] font-mono bg-zinc-950/50 px-2 py-1 rounded-md border border-border">Rust</span>
                <span className="text-[10px] font-mono bg-zinc-950/50 px-2 py-1 rounded-md border border-border">React</span>
              </div>
            </motion.div>
          </div>
        </div>
    ...
    <div className="marquee-content flex items-center whitespace-nowrap">
      ...
      <section className="px-6 max-w-7xl mx-auto">
        <div className="mb-12 flex justify-between items-end">
          <div>
            ...
            <p className="text-muted-foreground">My primary stack and favorite tools.</p>
          </div>
        </div>
      ...
      <section className="px-6 max-w-7xl mx-auto">
        <div className="mb-12">
          ...
          <h2 className="text-3xl font-bold tracking-tight">Recent Milestones</h2>
        </div>
